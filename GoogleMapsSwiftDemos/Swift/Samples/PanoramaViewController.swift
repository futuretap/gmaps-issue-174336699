...
class PanoramaViewController: UIViewController {
  ...
  private let markerLocation = CLLocationCoordinate2D(latitude: 40.7105516, longitude: -74.0074231)
...
extension PanoramaViewController: GMSPanoramaViewDelegate {
  ...
  func panoramaView(_ view: GMSPanoramaView, didMoveTo panorama: GMSPanorama?) {
    ...
    configured = true
	NSLog("links: \(panorama!.links.map{"\($0.panoramaID) / \($0.heading)"}.joined(separator: "\n"))")
  }
